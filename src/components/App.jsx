...
export class App extends Component {
  ...
  async componentDidUpdate(_, prevState) {
    ...
    if (prevState.searchQuery !== searchQuery || prevState.page !== page) {
      ...
      try {
        ...
        const totalpage = this.totalImage / 12;
  ...
  render() {
    const { selectedImage, isLoading, images, page } = this.state;
    return (
      <>
        <Searchbar
          onSubmit={this.handleFormSubmit}
          totalImage={this.totalImage}
        />
        {images.length > 0 && (
        ...
        {isLoading && <Loader />}
        {page < this.totalImage / 12 && <Button onClick={this.loadMore} />}
